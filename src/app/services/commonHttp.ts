...
import { LoadingService } from 'app/shared/loading-component/loading-component.services';
...
export class CommonApiService {
    ...
    uploadFileMau1 = (url: string, file: File, Object_id: any,Object_id1: any, nghiepvuCode: string): Observable<HttpEvent<any>> => {
        const formData: FormData = new FormData();
        formData.append('file', file, file.name);
        formData.append('Object_id', Object_id);
        formData.append('Object_id1', Object_id1);
        formData.append('nghiepvuCode', nghiepvuCode);
        const req = new HttpRequest('POST', url, formData, {
            reportProgress: true,
            responseType: 'json'
    ...
    uploadFileMau2 = (url: string, file: File, Object_id: any,Object_id1: any,Object_id2: any, nghiepvuCode: string): Observable<HttpEvent<any>> => {
        const formData: FormData = new FormData();
        formData.append('file', file, file.name);
        formData.append('Object_id', Object_id);
        formData.append('Object_id1', Object_id1);
        formData.append('Object_id2', Object_id2);
        formData.append('nghiepvuCode', nghiepvuCode);
        const req = new HttpRequest('POST', url, formData, {
            reportProgress: true,
            responseType: 'json'
